...
class ConfigurationProperty(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name", "value", "type", "label", "description", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["name", "value", "type", "label", "description", ], str]):

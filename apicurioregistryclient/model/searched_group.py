...
class SearchedGroup(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "description", "createdOn", "createdBy", "modifiedOn", "modifiedBy", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "description", "createdOn", "createdBy", "modifiedOn", "modifiedBy", ], str]):

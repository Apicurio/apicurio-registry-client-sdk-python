...
class GroupSearchResults(
        ...
        class properties:
            ...
            class groups(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['SearchedGroup']:
                        return SearchedGroup
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['SearchedGroup'], typing.List['SearchedGroup']],
                ...
                def __getitem__(self, i: int) -> 'SearchedGroup':
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["groups", "count", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["groups", "count", ], str]):

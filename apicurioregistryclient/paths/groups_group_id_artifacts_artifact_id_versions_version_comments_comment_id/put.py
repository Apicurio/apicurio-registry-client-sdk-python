...
# body param
SchemaForRequestBodyApplicationJson = NewComment


request_body_new_comment = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    @typing.overload
    def _update_artifact_version_comment_oapg(
        self,
    ...
    def _update_artifact_version_comment_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_new_comment.serialize(body, content_type)
...
class UpdateArtifactVersionComment(BaseApi):
    ...
    def update_artifact_version_comment(
        ...
        return self._update_artifact_version_comment_oapg(
            body=body,

...
SchemaFor200ResponseBodyApplicationJson = VersionSearchResults
...
class BaseApi(api_client.Api):
    @typing.overload
    def _list_artifact_versions_oapg(
        self,
...
class ListArtifactVersions(BaseApi):
    ...
    def list_artifact_versions(
        ...
        return self._list_artifact_versions_oapg(

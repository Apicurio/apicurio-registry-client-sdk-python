...
# body param
SchemaForRequestBodyApplicationJson = UpdateState


request_body_update_state = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _update_artifact_version_state_oapg(
        self: api_client.Api,
        ...
        _fields = None
        _body = None
        serialized_data = request_body_update_state.serialize(body, content_type)
...
class UpdateArtifactVersionState(BaseApi):
    ...
    def update_artifact_version_state(
        ...
        return self._update_artifact_version_state_oapg(
            body=body,

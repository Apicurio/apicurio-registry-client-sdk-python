...
# body param
SchemaForRequestBodyApplicationJson = ArtifactOwner


request_body_artifact_owner = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    @typing.overload
    def _update_artifact_owner_oapg(
        self,
    ...
    def _update_artifact_owner_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_artifact_owner.serialize(body, content_type)
...
class UpdateArtifactOwner(BaseApi):
    ...
    def update_artifact_owner(
        ...
        return self._update_artifact_owner_oapg(
            body=body,

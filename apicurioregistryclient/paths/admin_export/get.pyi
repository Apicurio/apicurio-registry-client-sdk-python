...
# Query params
ForBrowserSchema = schemas.BoolSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    ...
    {
        'forBrowser': typing.Union[ForBrowserSchema, bool, ],
    },
    total=False
)
...
request_query_for_browser = api_client.QueryParameter(
    name="forBrowser",
    style=api_client.ParameterStyle.FORM,
    schema=ForBrowserSchema,
    explode=True,
)
SchemaFor200ResponseBodyApplicationZip = schemas.BinarySchema
SchemaFor200ResponseBodyApplicationJson = DownloadRef

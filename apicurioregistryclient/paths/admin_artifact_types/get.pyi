...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['ArtifactTypeInfo']:
            return ArtifactTypeInfo

    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['ArtifactTypeInfo'], typing.List['ArtifactTypeInfo']],
    ...
    def __getitem__(self, i: int) -> 'ArtifactTypeInfo':
...
class ListArtifactTypes(BaseApi):
    ...
    def list_artifact_types(
        ...
        return self._list_artifact_types_oapg(

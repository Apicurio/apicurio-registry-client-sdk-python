...
SchemaFor200ResponseBodyApplicationJson = ConfigurationProperty
...
class GetConfigProperty(BaseApi):
    ...
    def get_config_property(
        ...
        return self._get_config_property_oapg(

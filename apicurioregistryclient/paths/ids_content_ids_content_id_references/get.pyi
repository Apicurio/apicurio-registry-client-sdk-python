...
request_path_content_id = api_client.PathParameter(
    name="contentId",
...
class BaseApi(api_client.Api):
    @typing.overload
    def _references_by_content_id_oapg(
        self,
...
class ReferencesByContentId(BaseApi):
    ...
    def references_by_content_id(
        ...
        return self._references_by_content_id_oapg(

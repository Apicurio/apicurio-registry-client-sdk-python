...
request_body_rule = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_artifact_rule_oapg(
        self,
    ...
    def _create_artifact_rule_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_rule.serialize(body, content_type)
...
class CreateArtifactRule(BaseApi):
    ...
    def create_artifact_rule(
        ...
        return self._create_artifact_rule_oapg(
            body=body,

...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['RuleType']:
            return RuleType

    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['RuleType'], typing.List['RuleType']],
    ...
    def __getitem__(self, i: int) -> 'RuleType':
...
class ListArtifactRules(BaseApi):
    ...
    def list_artifact_rules(
        ...
        return self._list_artifact_rules_oapg(

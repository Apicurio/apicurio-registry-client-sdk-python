...
# body param
SchemaForRequestBodyApplicationJson = CreateGroupMetaData


request_body_create_group_meta_data = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = GroupMetaData
...
class BaseApi(api_client.Api):
    ...
    def _create_group_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_create_group_meta_data.serialize(body, content_type)

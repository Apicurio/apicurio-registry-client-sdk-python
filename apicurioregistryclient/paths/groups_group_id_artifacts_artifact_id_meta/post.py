...
class BaseApi(api_client.Api):
    ...
    def _get_artifact_version_meta_data_by_content_oapg(
        self: api_client.Api,
        body: typing.Union[SchemaForRequestBody, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, bool, None, list, tuple, bytes, io.FileIO, io.BufferedReader, ],
...
class GetArtifactVersionMetaDataByContent(BaseApi):
    ...
    def get_artifact_version_meta_data_by_content(
        ...
        return self._get_artifact_version_meta_data_by_content_oapg(
            body=body,

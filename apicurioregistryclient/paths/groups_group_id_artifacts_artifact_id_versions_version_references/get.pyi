...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    ...
    {
        'refType': typing.Union[RefTypeSchema, ],
    },
    total=False
)
...
request_query_ref_type = api_client.QueryParameter(
    name="refType",
    style=api_client.ParameterStyle.FORM,
    schema=RefTypeSchema,
    explode=True,
)
# Path params
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_artifact_version_references_oapg(
        self,
...
class GetArtifactVersionReferences(BaseApi):
    ...
    def get_artifact_version_references(
        ...
        return self._get_artifact_version_references_oapg(

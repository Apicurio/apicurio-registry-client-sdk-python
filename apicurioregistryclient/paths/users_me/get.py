...
SchemaFor200ResponseBodyApplicationJson = UserInfo
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_current_user_info_oapg(
        self,
...
class GetCurrentUserInfo(BaseApi):
    ...
    def get_current_user_info(
        ...
        return self._get_current_user_info_oapg(
